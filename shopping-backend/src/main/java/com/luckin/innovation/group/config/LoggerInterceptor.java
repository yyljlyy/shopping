...
import com.luckin.innovation.group.service.impl.SystemLoggerService;
import com.luckin.innovation.group.utils.LoggerUtils;
...
public class LoggerInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
        ...
        //获取本次请求日志实体
        SystemLogger loggerEntity = (SystemLogger) request.getAttribute(LOGGER_ENTITY);
        //设置请求时间差
        ...
        loggerEntity.setReturnData(JSON.toJSONString(request.getAttribute(LoggerUtils.LOGGER_RETURN),
                ...
                SerializerFeature.WriteMapNullValue));
        //执行将日志写入数据库
        SystemLoggerService loggerService = (SystemLoggerService) SpringContextHolder.getBean("loggerService");
