...
CREATE TABLE `product` (
  ...
  `master_image` varchar(255) DEFAULT NULL COMMENT '主图',
  `product_desc` varchar(255) DEFAULT NULL COMMENT '商品描述',
  `is_hot` int(11) DEFAULT NULL COMMENT '热门商品',
  `second_categoryid` int(11) DEFAULT NULL COMMENT '二级分类',
...
-- Dump completed on 2018-11-27 18:30:50
