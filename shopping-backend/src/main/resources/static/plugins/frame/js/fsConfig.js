...
layui.define([], function (exports) {
	 ...
	 */
	fsConfig["global"] = {
		"servletUrl":"", //异步请求地址,本地工程可以不填，默认：https://admin.wueasy.com
		"loginUrl" : "/login", //登录url
		"uploadUrl" : "", //上传附件url，默认：https://fs.fallsea.com/upload
	    ...
	    "dataName" : "data", //非表格数据的字段名称，默认：results.data
			"file" : { //文件配置
	    	"path" : "data.filePath"  //返回文件路径属性，默认：results.data.filePath
	    }
		},
		"page" : { //分页配置
			...
			"response": {//响应配置
				"countName": "data.totalElements", //数据总数的字段名称，默认：results.data.total
				"dataName" : "data", //数据列表的字段名称，默认：results.data
				"dataNamePage": "data.content" //分页数据列表的字段名称，默认：results.data.list
			}//,
